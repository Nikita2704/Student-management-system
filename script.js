...
const studentsArray = [{ id: 1, name: 'Nikita', age: 24, grade: 'A', degree: 'M.Sc.', email: 'nikita@example.com' }, { id: 2, name: 'Bhoomi', age: 22, grade: 'B', degree: 'Mtech', email: 'bhoomi@example.com' }, { id: 3, name: 'Rashmi', age: 23, grade: 'C', degree:'B.tech', email: 'rashmi@example.com' } ];
let ID = 1;
